...
module.exports = {
SESSION_ID: process.env.SESSION_ID || "Gifted~CqxlCCBT#_arjMGiEKKtQBdvZPgHhRVKq-JWtR6EPDl6c6UKv4kU", // Add sess Id here espwcially when deploying on panels else use app.json and .env file...
SUDO_NUMBERS: process.env.SUDO_NUMBERS || "2348067725987, 2349025967964", //Add multiple Numbers with Country Codes without (+) Separated by Comma...
